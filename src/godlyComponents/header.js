        ...
        {/* Top row: Logo and Nav */}
          ...
          <nav>
            <ul className="flex gap-x-6 text-[#FDE4C8]">
              <li><a href="#" className="hover:text-gray-300  text-[#F3C99D]">SERVICES</a></li>
              <li><a href="#" className="hover:text-gray-300  text-[#F3C99D]">ABOUT US</a></li>
              <li><a href="#" className="hover:text-gray-300  text-[#F3C99D]">OUR PROMISE</a></li>
              <li><a href="#" className="hover:text-gray-300  text-[#F3C99D]">OUR PROCESS</a></li>
            </ul>
          </nav>
          </div>
