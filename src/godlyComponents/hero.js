...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-x-clip bg-[#1F1D1D]">
      <div
        className="absolute top-[50px] left-0 h-1/2 w-full bg-[url('/path-to-image.jpg')] bg-cover bg-top bg-no-repeat"
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-14 pb-32">
        <div className="flex min-h-[650px] flex-col justify-end gap-3 pb-10">
          ...
          <h1 className="text-7xl tracking-[6px] text-white">
            Window cleaning{" "}
            <span className="text-center font-['luminaire-script'] text-2xl text-[#FDE4C8]">
              And
            </span>{" "}
...
const Star = () => (
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_2048_27067)">
      <path
